...
char	*argv[];
{
   ...
   for(k=0;k<lines && tstart + k*line_range<len;++k)
   {
      ...
      if(input=fopen(Scodpot_file,"r")) { ++Scpf;
         while(fgets(longstr,198,input) && !feof(input))
         {
      ...
      if(input=fopen(unb_file,"r")) { unbf= 1;
         while(fgets(longstr,198,input) && !feof(input))
         {
      ...
      if(input= fopen(con_file,"r")) { conf= 1;
         while(fgets(longstr,198,input) && !feof(input))
         {
      ...
      if(input= fopen(new_file,"r")) { newf= 1;
         while(fgets(longstr,198,input) && !feof(input))
         {
      ...
      */
      ...
      for(i=0;i<nt;++i)
         if(tata_str[i]==' ') fprintf(stdout," %.1f %.2f M 0 5 RL 2 0 RL stroke\n",(tata[i]-(float)start)/delta*WIDTH,0.0);
         else                 fprintf(stdout," %.1f %.2f M 0 5 RL -2 0 RL stroke\n",(tata[i]-(float)start)/delta*WIDTH,0.0);
      ...
      for(i=0;i<ncca;++i)
         if(ccaa_str[i]==' ') fprintf(stdout," %.1f %.2f M 0 3 RL 2 0 RL stroke\n",(ccaa[i]-(float)start)/delta*WIDTH,0.0);
         else                 fprintf(stdout," %.1f %.2f M 0 3 RL -2 0 RL stroke\n",(ccaa[i]-(float)start)/delta*WIDTH,0.0);
      ...
      for(i=0;i<ncap;++i)
         if(cap_str[i]==' ') fprintf(stdout," %.1f %.2f M 0 4 RL 2 0 RL stroke\n",(cap[i]-(float)start)/delta*WIDTH,0.0);
         else                 fprintf(stdout," %.1f %.2f M 0 4 RL -2 0 RL stroke\n",(cap[i]-(float)start)/delta*WIDTH,0.0);
      ...
      for(i=0;i<ngcb;++i)
         if(gcbox_str[i]==' ') fprintf(stdout," %.1f %.2f M 0 2 RL 2 0 RL stroke\n",(gcbox[i]-(float)start)/delta*WIDTH,0.0);
         else                 fprintf(stdout," %.1f %.2f M 0 2 RL -2 0 RL stroke\n",(gcbox[i]-(float)start)/delta*WIDTH,0.0);
      ...
      for(i=0;i<nScp;++i)
      {
         ...
         if(Scodpot_str[i]==' ') fprintf(stdout," %.1f %.2f M %.1f %.2f L stroke\n",(Scodpot[i][0]-(float)start)/delta*WIDTH,HIGHT+HIGHT_SCP+1.0,(Scodpot[i][1]-(float)start)/delta*WIDTH,HIGHT+HIGHT_SCP+1.0);
         else if(Scodpot_str[i]=='C') fprintf(stdout," %.1f %.2f M %.1f %.2f L stroke\n",(Scodpot[i][0]-(float)start)/delta*WIDTH,HIGHT+HIGHT_SCP-1.0,(Scodpot[i][1]-(float)start)/delta*WIDTH,HIGHT+HIGHT_SCP-1.0);
      ...
      if(np || ne) fprintf(stdout,"/Times-Roman findfont NumberFontSize scalefont setfont\n");
